...
from MVC.model.Interfacce.attivitàInterface.AccountInterface import AccountInterface
...
class Account(ServizioInterface, AccountInterface):
    ...
    def aggiungiAccount(self, nome, cognome, dataDiNascita, email, numeroTelefonico, password, residenza):
        ...
        if not self.checkNumeroTelefonico(numeroTelefonico):
