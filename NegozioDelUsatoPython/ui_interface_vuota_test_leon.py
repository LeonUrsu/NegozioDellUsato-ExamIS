...
class Ui_InterfaceVuota(object):
    ...
    def modMainWindow(self, MainWindow):
    ...
    def addOrizontalLayoutToCentralWidget(self):
        self.horizontalLayout = QHBoxLayout(self.centralwidget)
        self.horizontalLayout.setSpacing(0)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
    def addLeftMenuToCentralWidget(self):
    ...
    def createFrame2withFrame6(self):
    ...
    # Metodo per la creazione del bottone nel left menu
    def creazioneButtonHomeBtn(self, font):
    ...
    # Metodo per la creazione del bottone nel left menu
    def creazioneButtonStatisticBtn(self, font):
    ...
    # Metodo per la creazione del bottone nel left menu
    def creazioneButtonProdottiBtn(self, font):
    ...
    def creazioneButtoninfoBtn(self, font):
    ...
    def setupUi(self, MainWindow):
        self.modMainWindow(MainWindow)
        self.createCentralWidget(MainWindow)
        self.addOrizontalLayoutToCentralWidget()
        self.addLeftMenuToCentralWidget()
        self.createFrame5()
        self.createFrame2withFrame6()
        font = self.creaFontLeftButtons()
        self.creaFontLeftButtons()
        self.creazioneButtonHomeBtn(font)
        self.creazioneButtonStatisticBtn(font)
        self.creazioneButtonProdottiBtn(font)
        self.creazioneButtoninfoBtn(font)
